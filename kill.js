...
const secureOptions =
 ...
 if (process.argv.length < 7) {
     console.log(gradient.vice('Usage: host time req thread proxy.txt'));
     process.exit();
 }
...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
  ...
  console.log(` - Time      ⏱️ `.brightRed + process.argv[3])
  console.log(` - Rate      🌐 `.brightRed + process.argv[4])
  console.log(` - Thread    🌐 `.brightRed + process.argv[5])
  console.log(` - Owen      : `.brightRed + "VLADIMIR")
  console.log(`--------------------------------------------`.gray)
  console.log(`Bypass Fl By @Umlaviem`.brightCyan)
    const restartScript = () => {
